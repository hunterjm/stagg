export interface ConfirmDiscordEmailParams {
    url: string
    jwt: string
}
export interface DiscordConfirmationEmailParams {
    jwt: string
    username: string
    discord: {
        id: string
...
export default function ({ jwt, username, discord }:DiscordConfirmationEmailParams) {
    return `
    <!DOCTYPE html>
    <html lang="en">
      <body
