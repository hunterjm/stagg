...
import { AccountRepository } from './callofduty/account/account'
import { AuthRepository } from './callofduty/account/auth'
...
createConnection(
   ...
   const accountRepo = connection.getCustomRepository(AccountRepository)
   ...
   const authRepo = connection.getCustomRepository(AuthRepository)
